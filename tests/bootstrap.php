 ...
 */
class GFMFI_Tests_Bootstrap {

	/** 
	 * The bootstrap instance.
	 *
	 * @var GFMFI_Tests_Bootstrap
	 */
	...
	public function load_plugin() {
		require_once( $this->plugin_dir . '/gravityforms-multiple-form-instances.php' );
	}

	/**
	 * Get the single tests boostrap instance
	 *
	 * @return GFMFI_Tests_Bootstrap
	 */
...
GFMFI_Tests_Bootstrap::instance();
